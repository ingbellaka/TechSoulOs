...
<style scoped>
@media(max-width:600px){.ts-metric-strip-four{grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:9px!important}.ts-mini-metric{padding:13px!important;min-height:105px!important}.ts-mini-metric strong{font-size:1.25rem!important}.ts-purchase-tabs{padding:8px 10px 0!important;overflow-x:auto;scrollbar-width:none}.ts-purchase-tabs button{white-space:nowrap;min-height:44px}.ts-orders-toolbar{padding:12px!important}.ts-purchase-list{padding:12px!important;gap:10px!important}.ts-purchase-card{padding:15px!important;gap:12px!important}.ts-purchase-main{align-items:flex-start!important}.ts-purchase-main h3{white-space:normal!important;overflow-wrap:anywhere;font-size:1rem!important}.ts-purchase-main small{font-size:.78rem!important}.ts-purchase-amount{text-align:left!important}.ts-purchase-amount strong{font-size:1.25rem!important}.ts-purchase-actions{display:grid!important;grid-template-columns:1fr!important;gap:8px!important}.ts-purchase-actions>*{width:100%!important;min-height:46px!important}.ts-purchase-row{grid-template-columns:1fr!important;padding:12px!important}.ts-purchase-row input,.ts-purchase-row select,.ts-purchase-meta input,.ts-purchase-meta select{font-size:16px!important;min-height:46px}.ts-remove-row{position:static!important;margin:0!important;width:100%!important;min-height:42px!important;border-radius:10px!important}.ts-form-actions{display:grid!important;grid-template-columns:1fr!important}.ts-form-actions>*{width:100%!important;min-height:48px!important}}
</style>